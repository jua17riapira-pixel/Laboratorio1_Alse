...
int ingresar (char *cadena1)
{
        ...
        scanf("%s", cadena1);
        //char delimitador1 [] =";";
        //char *token1 = strtok(cadena1, delimitador1);
        //int verdad=0;
        /*do
        {
                int digit=atoi(token1);
                fpurge(stdin);
                if (isdigit(digit) == 0)
                {
                        printf("\n Valor invalido, ingrese solo números en el formato indicado \n");
                        return 0;
                }
